...
class SearchBgHelper(
    ...
    val drawable: Drawable = mockDrawable ?:
    ...
    private val drawableLeft: Drawable = mockDrawable ?:
        GradientDrawable().apply {
            shape = GradientDrawable.RECTANGLE
    ...
    private val drawableMiddle: Drawable = mockDrawable ?:
        GradientDrawable().apply {
            shape = GradientDrawable.RECTANGLE
            cornerRadii = FloatArray(8).apply {
                fill(0f, 0, size)
    ...
    private val drawableRight: Drawable = mockDrawable ?:
        GradientDrawable().apply {
            shape = GradientDrawable.RECTANGLE
            cornerRadii = floatArrayOf(
                0f, 0f,
