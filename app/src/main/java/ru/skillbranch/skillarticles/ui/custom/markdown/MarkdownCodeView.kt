...
class MarkdownCodeView private constructor(
    ...
    init {
        tvCodeView = MarkdownTextView(context, fontSize*0.85f,false).apply {
            ...
            isFocusable = true //for Focus inside scroll
            isFocusableInTouchMode = true //for Focus inside scroll
        }
        svScroll = object : HorizontalScrollView(context) {
            ...
            isHorizontalFadingEdgeEnabled = true //semitransparent effect on the rigth side
